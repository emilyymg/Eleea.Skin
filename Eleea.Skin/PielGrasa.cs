...
namespace Eleea.Skin
{
    public partial class PielGrasa : UserControl
    {
        ...
        {
            // La BD ya conoce el precio. Solo necesitamos el Nombre y el Tipo de Piel.
        ...
        private void btncar9_Click(object sender, EventArgs e)
        {
            ...
            AgregarProductoAlCarrito("Pond's Sunscreen 50", "GRASA");

        }

        private void btncar10_Click(object sender, EventArgs e)
        {
            AgregarProductoAlCarrito("Garnier Limpiador Lemon", "GRASA");
        ...
        {
            AgregarProductoAlCarrito("Cetaphil Optimal Hydration", "GRASA");
        ...
        {
            AgregarProductoAlCarrito("Bioderma White Objective", "GRASA");
